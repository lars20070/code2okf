...
# Validate the Pi Docker Sandbox Kit spec (kits/code2okf/spec.yaml) against the
...
echo "Validating ${repo_root}/kits/code2okf against the current Sandbox Kit schema..."
exec sbx kit validate "${repo_root}/kits/code2okf/"
