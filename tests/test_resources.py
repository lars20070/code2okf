"""Tests for code2okf.resources."""

from pathlib import Path

import pytest

from code2okf import resources
...
def test_installed_root_preferred_when_it_carries_a_kit(tmp_path: Path, monkeypatch):
    fake_root = tmp_path / "installed" / "code2okf"
...
def test_installed_root_is_none_without_a_bundled_kit(tmp_path: Path, monkeypatch):
    ...
    assert resources.kit_dir() == resources._CHECKOUT_ROOT / "kits" / "code2okf"
